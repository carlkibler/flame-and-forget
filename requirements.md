...
- Submitting (Enter or clicking “Burn it for healing” button) spawns a decorative note/post-it element showing the phrase.
...
4. Input field + button (“Burn it for healing”) wired via vanilla JS.
